...
-- ALTER ROLE "authenticator" WITH NOINHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:vN0rp7/QutF/mcLqbcw3RA==$K0+TWkbgOiN9LmIYpOcoib2AqVvlWR+E4DTCfklGycE=:Ec6Fg4VuXkBp/Sso8uujvRzPzvsbUye8/sOFWpZSb9Y=';
-- CREATE ROLE "dashboard_user";
-- ALTER ROLE "dashboard_user" WITH INHERIT CREATEROLE CREATEDB NOLOGIN REPLICATION NOBYPASSRLS;
-- CREATE ROLE "pgbouncer";
-- ALTER ROLE "pgbouncer" WITH INHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:doABNFABdAnOCPtKp8wGCQ==$xN+BSw3UEYAodZhGodG1LWERElq1KZZc3wQu8dkLSF4=:ZvOh//z3NeSpIh6OI5aFPhkinPjUiH5i1slxznz1/+A=';
-- CREATE ROLE "postgres";
-- ALTER ROLE "postgres" WITH INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:36AMBUAnCh/yqUIn+9WDKA==$OAg41YR6/LXzYuNBEQ8xgACdp/hySo4C6icWixoQohk=:2jeTCiqfehfYfG9zW8MJWs8MX0dgAd7Ks54P48G0CVg=';
-- CREATE ROLE "service_role";
-- ALTER ROLE "service_role" WITH INHERIT NOCREATEROLE NOCREATEDB NOLOGIN BYPASSRLS;
-- CREATE ROLE "supabase_admin";
-- ALTER ROLE "supabase_admin" WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:35p2beyjOAcJfgtEjH3DRA==$esroNliDNdjx0MZYKAQvooLYhdoQJDdhaHbGexjfy3o=:34fepBeMK/hEPCB1y+ofqsNFAMcnJ6C/BOMuZ8BjW28=';
-- CREATE ROLE "supabase_auth_admin";
-- ALTER ROLE "supabase_auth_admin" WITH NOINHERIT CREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:9N5g577gkKB5SC2ICgI+Og==$qrl7uIUn57jzarhH6aGvkDTE0tg2y5TzDWt+gTwKozM=:9aOYq1uOLcKfFwVsNJ2fk0XdAm4g0QdeG3qUki3EQ6o=';
-- CREATE ROLE "supabase_functions_admin";
-- ALTER ROLE "supabase_functions_admin" WITH SUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:GsGyzUqo7jLVQsM+bKdPfQ==$oWhBF2uJZCXLrzFNoLXGv1oqJZhHnlHHTyogxotBlM8=:wgJXVI41FSIcNggyO6dkca7HuitN4LTyKH/h+6mFBbQ=';
...
-- ALTER ROLE "supabase_storage_admin" WITH NOINHERIT CREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:mcp6CM6Cw10m0Pr1TKfLAQ==$ygtBg9HwAD3TVQUOQo0knPlmEsRpjBtntY5JQmIXaq0=:SdxHsRgCH0EvlHSJNdCfa69of/ZuKzXPZZweJ/51rE4=';
...
--
-- Name: knowledge_content_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE "public"."knowledge_content_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: knowledge_content_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE "public"."knowledge_content_id_seq" OWNED BY "public"."knowledge_content"."id";
...
CREATE TABLE "public"."test_results" (
    ...
    "score" integer,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "test_results_test_type_check" CHECK (("test_type" = ANY (ARRAY['pre'::"text", 'post'::"text"])))
);
...
--
-- Name: knowledge_content id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."knowledge_content" ALTER COLUMN "id" SET DEFAULT "nextval"('"public"."knowledge_content_id_seq"'::"regclass");
...
ALTER TABLE ONLY "public"."user_actions"
    ADD CONSTRAINT "user_actions_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
--
-- Name: knowledge_content Admins can manage knowledge_content; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Admins can manage knowledge_content" ON "public"."knowledge_content" TO "authenticated" USING (("public"."get_user_role"("auth"."uid"()) = 'admin'::"public"."user_role"));


--
-- Name: system_config Admins can manage system_config; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Admins can manage system_config" ON "public"."system_config" TO "authenticated" USING (("public"."get_user_role"("auth"."uid"()) = 'admin'::"public"."user_role"));
...
--
-- Name: test_results Admins have full access to test_results; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Admins have full access to test_results" ON "public"."test_results" TO "authenticated" USING (("public"."get_user_role"("auth"."uid"()) = 'admin'::"public"."user_role"));


--
-- Name: user_actions Admins have full access to user_actions; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Admins have full access to user_actions" ON "public"."user_actions" TO "authenticated" USING (("public"."get_user_role"("auth"."uid"()) = 'admin'::"public"."user_role"));


--
-- Name: knowledge_content Anyone can read knowledge_content; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Anyone can read knowledge_content" ON "public"."knowledge_content" FOR SELECT TO "authenticated" USING (true);
...
CREATE POLICY "Anyone can read system_config" ON "public"."system_config" FOR SELECT TO "authenticated" USING (true);
...
CREATE POLICY "Users can insert their own actions" ON "public"."user_actions" FOR INSERT TO "authenticated" WITH CHECK (("auth"."uid"() = "user_id"));


--
-- Name: test_results Users can insert their own test results; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can insert their own test results" ON "public"."test_results" FOR INSERT TO "authenticated" WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can view their own actions" ON "public"."user_actions" FOR SELECT TO "authenticated" USING (("auth"."uid"() = "user_id"));
...
--
-- Name: test_results Users can view their own test results; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can view their own test results" ON "public"."test_results" FOR SELECT TO "authenticated" USING (("auth"."uid"() = "user_id"));
